...
cd ../instances/digital-asset-trading-platform
./startApp.sh
...
#    cli peer chaincode install -n fabcar -v 1.0 -p "github.com/fabcar/go" -l "golang"
#
#docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" \
#    -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" \
#    cli peer chaincode instantiate -o orderer.example.com:7050 -C mychannel -n fabcar -l "golang" -v 1.0 -c '{"Args":[""]}' -P "OR ('Org1MSP.member','Org2MSP.member')" \
...
#    -n fabcar -c '{"function":"initLedger","Args":[""]}' \
#    --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
